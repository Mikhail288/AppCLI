...
6.4 Создаем класс(`data class`) `ArgHandler` (поля `h`, `login`, `pass`) конструктор которого на вход получит массив параметров командной строки и распарсит их - 15 мин
