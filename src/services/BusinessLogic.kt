...
class BusinessLogic(
    ...
    fun authentication(login: String, pass: String, users: List<User>): ExitCode {
    ...
    fun authorization(login: String, role: String, resource: String, resources: List<Resources>): ExitCode {
